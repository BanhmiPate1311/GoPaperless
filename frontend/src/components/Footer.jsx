...
export const Footer = ({ headerFooter }) => {
  ...
  return (
    <footer
      ...
      style={{
        backgroundColor:
          headerFooter !== null && headerFooter?.footerBackgroundColor
            ? headerFooter.footerBackgroundColor
            : "#0b95e5",
        color:
          headerFooter !== null && headerFooter?.colorTextFooter
            ? headerFooter.colorTextFooter
            : "#FFF",
      }}
    >
      <div
        className="footer-inner"
        // style={{ backgroundColor: footer.colorFooter }}
      >
        <div
          className="row"
        ...
        >
          <div className="col-sm-8" style={{}}>
            <span>
              {t("single.version")}{" "}
              {headerFooter?.version ? headerFooter?.version : "1.20230830"}{" "}
              {t("single.copyright")} {new Date().getFullYear()} ©{" "}
          ...
          <div className="col-sm-4 text-right">
            <div className="pull-right">
              <div className="dis-flex align-items-center">
                ...
                <div style={{ margin: "0 3px", marginBottom: "3px" }}>
                  <svg
                    fill="#ffffff"
                    width="20"
                    height="15"
                ...
                {headerFooter?.phone ? headerFooter.phone : "+84978377152"}
              </div>
            </div>
          </div>
        </div>
