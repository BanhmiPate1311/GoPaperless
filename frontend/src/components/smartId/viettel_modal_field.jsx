              ...
              >
                ...
                >
                  ...
                  <Box flexGrow={1} textAlign="left">
                    ...
                    <Typography fontSize="14px">
                      {t("usb.usb11")}{" "}
                      {moment(value?.cert?.validFrom, "YYYYMMDDHHmmssZ").format(
                        "DD/MM/YYYY"
                      )}{" "}
                      {t("usb.usb12")}{" "}
                      {moment(value?.cert?.validTo, "YYYYMMDDHHmmssZ").format(
                        "DD/MM/YYYY"
                      )}
                    </Typography>
                  </Box>
...
export default ViettelModalField;
